        ...
        <div class="bg-white rounded shadow p-4">
          <iframe class="w-100 rounded mb-4" height ="320" src="<?php echo $contact_r['iframe']?>" loading="lazy"></iframe>
            ...
            <h5 class="mt-4"> Nous contacter </h5>
              <a href="tel: 0908070605" class="i-inline-block mb-2 text-decoration-none text-dark">
                 <i class="bi bi-telephone-forward-fill"></i>  0908070605                
              </a>
              <br>
              <br>
              <a href="tel: 0601020304 " class="i-inline-block text-decoration-none text-dark">
                 <i class="bi bi-telephone-forward-fill"></i> 0601020304             
              </a>
            
              <h5 class="mt-4"> E-mail </h5>
              <a href="mailto: Hypnos@gmail.com class="d-inline-block text-decoration-none text-dark">
                 <i class="bi bi-envelope-open-fill"></i> Hypnos@gmail.com
              </a>
